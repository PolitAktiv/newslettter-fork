...
package net.zylk.liferay.portal.impl;
 ...
 *
 * MOD: 
 * Comentado el codigo que hace referencia a las clases:
 * XSLTemplateResource, XSLURIResolver y JournalXSLURIResolver
 * para no tener que anadir esas dependencias (pierde el soporte de XSL).
 * 
 */
...
public class Transformer {
	...
	protected Template getTemplate(
		...
		if (langType.equals(TemplateConstants.LANG_TYPE_XSL)) {
			...
			// zylk: De momento no se soporta XSL
